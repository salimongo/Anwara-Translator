...
(() => {
  const TEXT_KEYS = Object.freeze({
    ...
    '历史翻译': 'history', '阅读区': 'readingArea', '词汇': 'vocabulary', '刷新': 'refresh', '管理': 'manage', '收起': 'collapse',
    ...
    '目录': 'toc', '复制译文': 'copyTranslation', '收藏选中': 'saveSelected', '先在正文中选中词语或句子': 'selectReaderTextFirst', '双语阅读': 'bilingualReading', '重新翻译': 'retranslate',
